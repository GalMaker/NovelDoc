    ...
    def parse_START(prim__state, prim__tokens):
        ...
        if lcl_0:
            ...
            if lcl_1:
                ...
                lcl_2 = (lcl_2, 'quote NOVEL_START not match')
                lcl_2 = prim__cons(lcl_2, prim__nil)
                lcl_2 = lcl_2
                lcl_2 = (False, lcl_2)
                lcl_1 = lcl_2
                ...
                if lcl_2:
                    ...
                    if lcl_3:
                        ...
                        lcl_4 = (lcl_4, 'quote NOVEL_END not match')
                        lcl_4 = prim__cons(lcl_4, prim__nil)
                        lcl_4 = lcl_4
                        lcl_4 = (False, lcl_4)
                        lcl_3 = lcl_4
    ...
    def parse_Say(prim__state, prim__tokens):
        ...
        if lcl_0:
            ...
            if lcl_1:
                ...
                lcl_3 = lcl_3.idint
                if (lcl_3 == 15):
                    lcl_4 = parse_Str(prim__state, prim__tokens)
                    _slot_1_check = lcl_4
                    lcl_4 = _slot_1_check[0]
                    lcl_4 = (lcl_4 is False)
                    if lcl_4:
                    ...
                    if lcl_4:
                        ...
                        lcl_5 = lcl_5
                        _slot_1 = lcl_5
                        lcl_5 = parse_Str(prim__state, prim__tokens)
                        _slot_2_check = lcl_5
                        lcl_5 = _slot_2_check[0]
                        lcl_5 = (lcl_5 is False)
                        if lcl_5:
                    ...
                    lcl_4 = (_off_1, 'Say lookahead failed')
                    lcl_4 = prim__cons(lcl_4, prim__nil)
                    lcl_4 = lcl_4
                    lcl_4 = (False, lcl_4)
                    lcl_2 = lcl_4
